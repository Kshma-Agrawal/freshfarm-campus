...
// ── Realistic images via Unsplash (no local asset dependencies) ───
const farmerRaniImg      = 'https://images.unsplash.com/photo-1607453998774-d533f65dac99?w=400&q=80'
const farmerHarpalImg    = 'https://images.unsplash.com/photo-1595475038784-bbe439ff41e6?w=400&q=80'
const farmerSunriseImg   = 'https://images.unsplash.com/photo-1500382017468-9049fed747ef?w=600&q=80'
const productTomatoesImg = 'https://images.unsplash.com/photo-1592924357228-91a4daadcfea?w=400&q=80'
const productSpinachImg  = 'https://images.unsplash.com/photo-1576045057995-568f588f82fb?w=400&q=80'
const productMilkImg     = 'https://images.unsplash.com/photo-1550583724-b2692b85b150?w=400&q=80'
const productCarrotImg   = 'https://images.unsplash.com/photo-1598170845058-32b9d6a5da37?w=400&q=80'
const productBananaImg   = 'https://images.unsplash.com/photo-1571771894821-ce9b6c11b08e?w=400&q=80'
const productKaleImg     = 'https://images.unsplash.com/photo-1524179091875-bf99a9a6af57?w=400&q=80'
const veggiesCrateImg    = 'https://images.unsplash.com/photo-1597362925123-77861d3fbac7?w=600&q=80'
...
export const FARMERS = [
  {
    ...
    specialty: 'Specializes in organic vegetables and seasonal greens',
    tags: ['Organic', 'Seasonal'],
    img: farmerRaniImg, verified: true,
  ...
  },
  {
    ...
    specialty: 'Seasonal fruits and fresh vegetables delivered daily',
    tags: ['Fresh Today', 'Premium'],
    img: farmerHarpalImg, verified: true,
  ...
  },
  {
    ...
    img: farmerSunriseImg, verified: true,
    desc: 'Specializes in organic vegetables and seasonal greens, grown without synthetic pesticides.',
    reviewText: '"The best heirloom tomatoes I\'ve ever had! I can\'t wait to see what other produce they bring this season."',
    reviewAuthor: 'Deepak S.',
  },
  {
    ...
    specialty: 'Fresh dairy products delivered daily from grass-fed cows',
    tags: ['Fresh Today'],
    img: farmerHarpalImg, verified: false,
  ...
  },
  {
    ...
    specialty: 'Root vegetables grown without chemicals in mineral-rich soil',
    tags: ['Seasonal'],
    img: farmerRaniImg, verified: false,
...
export const PRODUCTS = [
  {
    ...
    price: 60, unit: 'kg', img: productTomatoesImg, category: 'Vegetables', stock: true,
    ...
    reviewText: '"The sweetest tomatoes I\'ve ever tasted! You can really tell they are fresh from the farm."',
    reviewAuthor: 'Ansh B.',
    images: [productTomatoesImg, productSpinachImg, productCarrotImg],
  },
  {
    id: 2, name: 'Spinach (palak)', farmer: 'Harpal Singh Farm', farmerId: 2,
    price: 25, unit: 'bunch', img: productSpinachImg, category: 'Vegetables', stock: true,
  ...
  },
  {
    ...
    price: 50, unit: 'ltr', img: productMilkImg, category: 'Dairy', stock: true,
  ...
  },
  {
    ...
    price: 30, unit: 'kg', img: productCarrotImg, category: 'Vegetables', stock: true,
    desc: 'Our organic carrots are harvested daily from the rich, fertile soils of the North Valley. Grown without synthetic pesticides or fertilizers. Perfect for juicing, roasting, or snacking raw.',
    rating: 4.5, reviews: 128,
    reviewText: '"The sweetest carrots I\'ve ever tasted! You can really tell they are fresh from the farm."',
    reviewAuthor: 'Ansh B.',
  ...
  },
  {
    ...
    price: 35, unit: 'dozen', img: productBananaImg, category: 'Fruits', stock: true,
  ...
  },
  {
    ...
    price: 40, unit: 'bunch', img: productKaleImg, category: 'Vegetables', stock: true,
  ...
  },
  {
    ...
    price: 25, unit: 'kg',
    img: 'https://images.unsplash.com/photo-1449300079323-02e209d9d3a6?w=400&q=80',
    ...
    images: [
      ...
      productCarrotImg, productTomatoesImg,
    ],
  },
  {
    ...
    images: [
      ...
      productSpinachImg, productCarrotImg,
    ],
  },
  {
    id: 9, name: 'Green Beans', farmer: 'Sunrise Farms', farmerId: 3,
    price: 45, unit: 'kg',
    img: 'https://images.unsplash.com/photo-1567375698348-5d9d5ae99de0?w=400&q=80',
    category: 'Vegetables', stock: true,
    desc: 'Tender, crisp green beans harvested at peak freshness. No strings, just pure crunch.',
    rating: 4.4, reviews: 72,
    reviewText: '"Perfect beans, very fresh and tender."',
    reviewAuthor: 'Pooja R.',
    images: [
      'https://images.unsplash.com/photo-1567375698348-5d9d5ae99de0?w=400&q=80',
      productTomatoesImg, productKaleImg,
    ],
  },
]
...
export const ORDERS = [
  {
    ...
    delivery: '123 University Hall, Campus Exit',
    estimatedArrival: 'Today, 5:30 PM',
  },
  {
    id: 'FFC-12346',
    date: '28 Mar, 10:12 pm',
    amount: 315.00,
    status: 'cancelled',
    items: [
...
export const ADDRESSES = [
  {
    id: 1, label: 'Home', current: true,
    address: '123 Campus Lane, Block B, Gurgaon, Haryana, 122018',
    phone: '+91 87664 92210', icon: '🏠',
  },
  {
    id: 2, label: 'Office', current: false,
    address: '456 Business Park, Sector 34, Gurgaon, Haryana, 122001',
    phone: '+91 98765 43210', icon: '🏢',
  },
  {
    id: 3, label: 'Warehouse', current: false,
    address: '789 Knowledge Road, Zone 5, Gurgaon, Haryana, 122002',
    phone: '+91 99999 88888', icon: '🏭',
  },
]